...
This work [is distributed](https://github.com/NibiriTheMan/ion.lua/blob/main/ion/LICENSE) under [MPL 2.0](https://www.mozilla.org/en-US/MPL/2.0/).
...
To begin, install the module (from either Releases, https://nibiritheman.github.io/ion.lua/downloads.html, or the folder named ion) somewhere into your codebase, then do something akin to:
```lua
